...
GGUF(`qwen_v3.Q4_K_M.gguf`, ~374MB)는 APK에 포함하지 않는다(앱 비대). 두 방법:
...
### 방법 B — adb push
```
adb push models/gguf/v3/qwen_v3.Q4_K_M.gguf \
  /sdcard/Android/data/com.vibezent.calendaragent/files/qwen_v3.Q4_K_M.gguf
```
→ 앱에서 **"모델 로드"** 클릭
